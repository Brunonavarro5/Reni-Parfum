export function Select({ children }) { return <div className='w-full border p-2 rounded'>{children}</div>; }
...
export function SelectItem({ value, children }) { return <div className='p-1'>{children}</div>; }